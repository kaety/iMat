		...
		groupLayout.setHorizontalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					.addGap(12)
					.addComponent(panel, GroupLayout.PREFERRED_SIZE, 545, Short.MAX_VALUE)
					.addGap(8))
				.addGroup(groupLayout.createSequentialGroup()
					.addGap(84)
					.addComponent(lblSomIcaFast, GroupLayout.DEFAULT_SIZE, 383, Short.MAX_VALUE)
					.addGap(98))
				.addGroup(groupLayout.createSequentialGroup()
					.addGap(45)
					.addComponent(picLabel1, GroupLayout.DEFAULT_SIZE, 78, Short.MAX_VALUE)
					.addGap(137)
					.addComponent(picLabel2, GroupLayout.DEFAULT_SIZE, 79, Short.MAX_VALUE)
					.addGap(146)
